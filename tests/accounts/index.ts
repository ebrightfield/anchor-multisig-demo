...
// To suppress some Typsecript warnings about a javascript technique of
// using `.default` to access an entire JSON object.
export interface JSONDefault {
  default: never;
}

// Pre-saturated test accounts -- simple system accounts, balance of 1 SOL.
